...
<body>
        ...
        <div class="info-section">
            <div class="form-row">
                <div class="form-group-small">
                    ...
                    <input type="text" id="tester" value="{user_data['tester']}" maxlength="15">
                </div>
                <div class="form-group-small">
    ...
    <script>
        ...
        function saveProgress() {{
            ...
            if (!userData.tester || !userData.cliente || !userData.numero_historia || 
                ...
                if text_content:
                    ...
                    if test_items:
                        ...
                        with st.expander("Informações do Teste", expanded=True):
                            ...
                            with col1:
                                tester = st.text_input("Tester:", max_chars=15)
